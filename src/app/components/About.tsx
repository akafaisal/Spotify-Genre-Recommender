      ...
      <div className="max-w-5xl mx-auto bg-white/30 backdrop-blur-md  p-10 rounded-3xl shadow-lg">
        ...
        <Tabs defaultValue="features" className="w-full">
          ...
          <TabsContent value="features" className="space-y-4 mb-8">
            ...
            <ul className="list-disc pl-6 space-y-3 text-base leading-relaxed">
              ...
              <li>
                ...
                related genres are learned and influence future recommendations.
              </li>
              <li>
              ...
              <li>
                🔄 <strong>Auto-refresh</strong> — Re-clicking a mood refreshes
          ...
          <TabsContent value="tech" className="space-y-4 mb-8">
            <p className="text-lg">
              Genrify combines cutting-edge web technologies to create a smooth,
              fast, and intelligent experience. Everything runs on a lightweight
              stack designed for scalability and personalization.
            </p>

            <ul className="list-disc pl-6 space-y-3 text-base leading-relaxed">
              <li>
                ⚙️ <strong>Framework:</strong> Next.js (App Router, TypeScript)
              </li>
              <li>
              ...
              <li>
                🗄️ <strong>Database:</strong> MongoDB (via Mongoose) for storing
                liked genres and preferences.
              </li>
              <li>
