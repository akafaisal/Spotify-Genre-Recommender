...
export default function Working() {
  return (
    <>
      ...
      <div className=" bg-white/30 rounded-3xl backdrop-blur-md max-w-3xl w-4/5 mx-auto p-10">
        <Accordion type="single" collapsible className="space-y-2">
          <p className="font-honk text-4xl text-center mb-6">
            ✨ HOW IT WORKS?{" "}
          </p>
          ...
          <AccordionItem value="step-2" className="border-black">
            ...
            <AccordionContent className="bg-black rounded-3xl p-5 w-6/7 font-semibold mb-3">
              ...
              perfectly. <br /> Explore new tracks, rediscover old favorites,
              and find hidden gems. <br />
          ...
          <AccordionItem value="step-3" className="border-black">
            ...
            <AccordionContent className="bg-black rounded-3xl p-5 w-6/7 font-semibold mb-3">
              ...
              Genrify breaks down each mood into multiple sub-genres, helping
              you discover music that fits your exact taste profile. <br />
          ...
          <p className="text-sm font-mono italic text-zinc-900  mt-8 pt-4">
            ...
            uses the Spotify Web API for educational purpose. <br /> Genrify is
